        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <section>
                    ...
                    <p>For questions about these Terms of Service, please contact us at <a href="mailto:pckhien@gmail.com" class="text-primary hover:underline">pckhien@gmail.com</a> or visit our <a href="{{ route('contact') }}" class="text-primary hover:underline">contact page</a>.</p>
                </section>
            </div>
        </div>
    </main>
