...
@section('title', 'Privacy Policy - SocialTools')
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
                <section>
                    ...
                    <p>SocialTools ("we", "our", or "us") operates the SocialTools website and service. This Privacy Policy explains how we collect, use, store, and protect your personal information when you use our service to transfer videos from Google Photos to YouTube.</p>
                    <p class="mt-3">By using SocialTools, you agree to the collection and use of information in accordance with this policy.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="mb-3">SocialTools requests the following Google OAuth scopes:</p>
                    <ul class="list-disc pl-6 space-y-2">
                        <li><strong class="text-slate-900 dark:text-white">OpenID / Email / Profile:</strong> <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">openid</code>, <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">email</code>, <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">profile</code> — to identify your Google account and display your account name and email address in the SocialTools dashboard.</li>
                ...
                <section>
                    ...
                    <p class="mb-3">We use your information solely to provide and improve the SocialTools service:</p>
                    <ul class="list-disc pl-6 space-y-2">
                ...
                <section>
                    ...
                    <p class="mb-3">SocialTools uses <a href="https://developers.google.com/youtube/terms/api-services-terms-of-service" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">YouTube API Services</a> and the Google Photos Picker API. Our use and transfer of information received from Google APIs to any other app adheres to the <a href="https://developers.google.com/terms/api-services-user-data-policy" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
                ...
                <section>
                    ...
                    <p class="mb-3">We retain your account data for as long as your account is active. You may disconnect your Google accounts or delete your SocialTools account at any time. When you do:</p>
                    <ul class="list-disc pl-6 space-y-2">
                    ...
                    <p class="mt-3">When you disconnect a Google account through SocialTools, all associated OAuth tokens and data are deleted within 7 calendar days. When you revoke access via your Google Account settings, all associated data is deleted within 30 calendar days.</p>
                    <p class="mt-3">You can also revoke SocialTools's access via your <a href="https://myaccount.google.com/permissions" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google Account permissions page</a> or the <a href="https://security.google.com/settings/security/permissions" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google Security Settings page</a>.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="mb-3">SocialTools uses YouTube API Services and the Google Photos Picker API. These third-party services have their own policies:</p>
                    <ul class="list-disc pl-6 space-y-2">
