        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="prose prose-slate dark:prose-invert max-w-none space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
                ...
                <section>
                    ...
                    <ul class="list-disc pl-6 space-y-2">
                        <li><strong class="text-slate-900 dark:text-white">Google Photos:</strong> <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">https://www.googleapis.com/auth/photospicker.mediaitems.readonly</code> — to let you browse and select videos from your Google Photos library via the Picker API.</li>
                        <li><strong class="text-slate-900 dark:text-white">YouTube Upload:</strong> <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">https://www.googleapis.com/auth/youtube.upload</code> — to upload your selected videos to your YouTube channel.</li>
                        <li><strong class="text-slate-900 dark:text-white">YouTube Readonly:</strong> <code class="text-sm bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">https://www.googleapis.com/auth/youtube.readonly</code> — to list your YouTube playlists so you can assign uploaded videos to a playlist.</li>
                    </ul>
                    <p class="mt-3">We request only the minimum scopes necessary to provide the video transfer functionality. No other Google data is accessed.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="mt-3">You can also revoke Photos2Tube's access via your <a href="https://myaccount.google.com/permissions" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Google Account permissions page</a>.</p>
                </section>
                ...
                <section>
                    ...
                    <p class="mb-3">Photos2Tube integrates with the following third-party services, which have their own privacy policies:</p>
                    <ul class="list-disc pl-6 space-y-2">
                ...
                <section>
                    <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-3">11. Changes to This Policy</h2>
                ...
                <section>
                    <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-3">12. Contact Us</h2>
