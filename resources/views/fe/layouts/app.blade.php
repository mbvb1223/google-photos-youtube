...
<html class="light" lang="en"><head>
    ...
    <title>@yield('title', 'SocialTools - Transfer Videos Between Platforms')</title>
...
<div class="relative min-h-screen flex flex-col soft-gradient">
    <header class="w-full max-w-7xl mx-auto px-6 lg:px-10 py-6 flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('register') }}" class="bg-primary hover:bg-primary/90 text-white px-5 py-2.5 text-sm font-bold rounded-lg transition-all shadow-lg shadow-primary/20">
                Sign Up
            </a>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                ...
                <div class="grid grid-cols-2 md:grid-cols-2 col-span-1 md:col-span-2 gap-8">
                    <div class="flex flex-col gap-4">
                        <h3 class="text-sm font-semibold text-slate-900 dark:text-white uppercase tracking-wider">Product</h3>
                        <nav class="flex flex-col gap-3">
                            <a class="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors text-sm" href="{{ route('how-it-works') }}">How It Works</a>
                            <a class="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors text-sm" href="{{ route('pricing') }}">Pricing</a>
                            <a class="text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-primary transition-colors text-sm" href="{{ route('contact') }}">Contact</a>
                        </nav>
                    </div>
                    <div class="flex flex-col gap-4">
